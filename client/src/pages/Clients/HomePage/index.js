  ...
  const getlistCategory = async () => {
    try {
      ...
      if (branchRes?.data?.success) {
        if (branchRes?.data?.payload?.length) {
          setlistCategory(branchRes?.data?.payload);
          setCurrentSelectedTab(branchRes?.data?.payload[0]?._id);
        }
      }
    } catch (error) {
    ...
    <div>
      ...
      <section className="why_section layout_padding">
        <div className="container">
          <div className="heading_container heading_center">
            <h2>Tại sao lựa chọn cửa hàng chúng tôi</h2>
          </div>
          <div className="row">
            <div className="col-md-4">
              <div className="box ">
                ...
                <div className="detail-box">
                  ...
                  <p>Đảm bảo giao hàng trong 24h khi xác nhận đơn hàng</p>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="box ">
                ...
                <div className="detail-box">
                  ...
                  <p>Miễn phí vận chuyển với hoá đơn trên 250.000VNĐ</p>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="box ">
                ...
                <div className="detail-box">
                  ...
                  <p>Sản phẩm là hàng chính hãng, có kiểm định rõ ràng</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="row">
              <div className="col-md-6 ml-auto">
                ...
                <p style={{ marginTop: "20px", marginBottom: "30px" }}>
                  Sản phẩm của chúng tôi luôn đảm bảo về chất lượng, uy tín,
                  được kiểm định nguồn gốc rõ ràng, hãy LỰA CHỌN chúng tôi nhé!
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="product_section layout_padding">
        <div className="container">
          ...
          {/* Category Tab */}
          <div className="home_category_tab">
            <div className="layout">
              {listCategory?.map((categotyItem, categoryIndex) => {
                return (
                  <>
                    <input
                      name="nav"
                      ...
                      id={`category-${categotyItem?._id}`}
                      defaultChecked="checked"
                    />
                    <label
                      className="nav"
                      htmlFor={`category-${categotyItem?._id}`}
                      onClick={() =>
                        setCurrentSelectedTab(categotyItem?._id)
                      }
                      style={
                        currentSelectedTab === categotyItem?._id
          ...
          {/* Tab Product */}
          <TabProduct categorySelected={currentSelectedTab} />
          <div className="btn-box">
            <a href="/product">Xem tất cả sản phẩm</a>
          </div>
        </div>
      </section>
              ...
              <div className="carousel-item active">
                <div className="box col-lg-10 mx-auto">
                  ...
                  <div className="detail-box">
                    ...
                    <h6>Khách hàng</h6>
                    <p>
                      Sản phẩm chất lượng, rất đáng mua. Tôi đã mua được một
                      lần, nhất định sẽ quay lại vào những lần sau. Dịch vụ tại
                      nơi này chắc chắn không làm bạn thất vọng
                    </p>
                  </div>
                </div>
              </div>
              <div className="carousel-item">
                <div className="box col-lg-10 mx-auto">
                  ...
                  <div className="detail-box">
                    ...
                    <h6>Khách hàng</h6>
                    <p>
                      Tôi yêu thích sản phẩm và cách phục vụ tại của hàng. Tôi
                      đã mua được một lần, nhất định sẽ quay lại vào những lần
                      sau. Dịch vụ tại nơi này chắc chắn không làm bạn thất vọng
                    </p>
                  </div>
                </div>
              </div>
              <div className="carousel-item">
                <div className="box col-lg-10 mx-auto">
                  ...
                  <div className="detail-box">
                    ...
                    <h6>Khách hàng</h6>
                    <p>
                      Cửa hàng có nhiều dịch vụ rất tốt. Tôi đã mua được một
                      lần, nhất định sẽ quay lại vào những lần sau. Dịch vụ tại
                      nơi này chắc chắn không làm bạn thất vọng
                    </p>
                  </div>
